...
echo "== extension"; MDR_CHROME="$CFT" node test/ext-test.mjs http://127.0.0.1:8477/sample.md "$OUT/ext" | grep -E '"(mounted|tables|filesHidden|editRendered|pinchOk|buttonsOk)"|EXC'; E=${PIPESTATUS[0]}
kill $SRV 2>/dev/null
